...
const AdminDashboard = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6 bg-canvas text-body font-sans">
      
      {/* Title */}
      <div>
        <h1 className="text-3xl font-serif tracking-tight text-ink font-medium flex items-center gap-2.5">
          <Settings className="h-6 w-6 text-primary" /> System Administration Console
        </h1>
        <p className="mt-1 text-xs text-muted">Monitor system services connectivity and control database resets for live project vivas.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass-card p-4 space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-[9px] text-muted font-bold uppercase tracking-wider">Database Core</span>
            <Database className="h-4 w-4 text-primary" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-ink">MongoDB Atlas</h3>
            <p className="text-[11px] text-muted mt-0.5">Stores contracts, extracted clauses, and executive summaries.</p>
          </div>
          <div className="pt-2 border-t border-hairline">
            {loading ? <span className="text-[10px] text-muted">Checking...</span> : (
        ...
        <div className="glass-card p-4 space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-[9px] text-muted font-bold uppercase tracking-wider">Cognitive Engine</span>
            <ShieldCheck className="h-4 w-4 text-primary" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-ink">Gemini LLM API</h3>
            <p className="text-[11px] text-muted mt-0.5">Extracts clauses, rates risks, and drives interactive RAG chat.</p>
          </div>
          <div className="pt-2 border-t border-hairline">
            {loading ? <span className="text-[10px] text-muted">Checking...</span>
        ...
        <div className="glass-card p-4 space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-[9px] text-muted font-bold uppercase tracking-wider">Graph Relations</span>
            <RefreshCw className="h-4 w-4 text-primary" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-ink">Neo4j Graph</h3>
            <p className="text-[11px] text-muted mt-0.5">Indices dependencies and traces legal cross-clause reference paths.</p>
          </div>
          <div className="pt-2 border-t border-hairline">
            {loading ? <span className="text-[10px] text-muted">Checking...</span>
      ...
      {/* Danger Zone */}
      <div className="glass-card p-4 space-y-4 border border-red-200 bg-red-50/30">
        <div>
          <h3 className="text-sm font-semibold text-ink flex items-center gap-2">
            <ShieldAlert className="h-4 w-4 text-error animate-pulse" /> Danger Zone
          </h3>
          <p className="text-[11px] text-muted mt-0.5">Actions in this panel are destructive and will clear the system.</p>
        </div>
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-red-50 p-3 rounded-lg border border-red-200">
          <div className="space-y-0.5 text-center sm:text-left">
            <h4 className="text-xs font-semibold text-ink">Full System Reset</h4>
            <p className="text-[10px] text-muted leading-normal max-w-md">Deletes all records from MongoDB and empties the Neo4j graph nodes. Useful before beginning a live project viva presentation.</p>
          </div>
        ...
        {message && (
          <div className="p-2.5 bg-canvas rounded-lg border border-hairline text-[10px] text-center text-primary font-bold uppercase tracking-wider animate-pulse">{message}</div>
        )}
      </div>

      {/* Viva Checklist */}
      <div className="glass-card p-4 space-y-3">
        <h3 className="text-xs font-semibold text-ink uppercase tracking-wider">University Presentation / Viva Checklist</h3>
